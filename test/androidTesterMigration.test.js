...
test('production-baseline migration guard, preflight, upgrade and restart', async t => {
  ...
  assert.deepEqual(before.pending, ['013_partner_access.sql','014_tester_invitations.sql','015_android_tester_eligibility.sql','016_demo_feedback.sql','017_demo_feedback_comprehension.sql','018_package_demo_feedback.sql','019_combined_demo_feedback.sql']);
