...
function createPartnerMailAdapter(env = process.env, { createTransport, fetchImpl } = {}) {
  ...
  if (env.ZIPPI_PARTNER_MAIL_ADAPTER === "resend") return createResendMailAdapter(env, { fetchImpl });
