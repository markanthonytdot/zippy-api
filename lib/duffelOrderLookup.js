...
function createDuffelOrderLookup({
  ...
  if (!normalizedToken.startsWith("duffel_test_") && !normalizedToken.startsWith("duffel_live_")) {
    throw new Error("Duffel recovery lookup requires a recognized test or live token");
  }
