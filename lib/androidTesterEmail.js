...
<p style="padding:20px 0 30px;"><a href="${ANDROID_TEST_URL}" style="display:inline-block;background:#e7b858;color:#181818;text-decoration:none;font-weight:bold;padding:16px 24px;border-radius:10px;">Join Android Test</a></p>
  ...
  return { subject, html, attachments: [inlineLogo()], text: `${subject}\n\n${steps.map((step, i) => `${i + 1}. ${step}`).join('\n')}\n\nJoin Android Test:\n${ANDROID_TEST_URL}\n\nNeed help? Contact support@heyzippi.com.\n\nThe Zippi Team\nZippi Technologies` };
}
